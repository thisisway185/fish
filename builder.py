...
def clear():
	if platform == "linux" or platform == "linux2":
		...
		os.system('cls')
clear()
en = base64.b64decode('Q29kZWQgYnkgQHNsaXZtZW5z')
...
print(Fore.GREEN + '+' + Fore.BLUE +  "       Developer: @slivmens         " + Fore.GREEN + '+')
print(Fore.GREEN + '+' + Fore.BLUE +  "        Channel: @slivmens         " + Fore.GREEN + '+')
print(Fore.GREEN + '#########################################')
